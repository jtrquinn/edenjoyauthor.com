				...
				<div class="mx-auto max-w-2xl lg:max-w-5xl">
					<div class="max-w-2xl">
						...
						<p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
							I'm Eden Joy, a historical fantasy author who writes wholesome, heartfelt stories about
							characters striving to create a better world. Growing up with foster siblings shaped my
							passion for storytelling, and I write for teens who need to feel seen in their struggles,
							hopes, and dreams.
						</p>
						...
						<div class="mt-6 flex gap-6">
							<a class="group -m-1 p-1" aria-label="Follow on Instagram"
								href="https://www.instagram.com/eden.joy.writes/" target="_blank">
							...
							<a class="group -m-1 p-1" aria-label="Checkout my Etsy" href="#">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
									class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
									<path
										d="M384 348c-1.8 10.8-13.8 110-15.5 132-117.9-4.3-219.9-4.7-368.5 0v-25.5c45.5-8.9 60.6-8 61-35.3 1.8-72.3 3.5-244.1 0-322-1-28.5-12.1-26.8-61-36v-25.5c73.9 2.4 255.9 8.6 363-3.8-3.5 38.3-7.8 126.5-7.8 126.5H332C320.9 115.7 313.2 68 277.3 68h-137c-10.3 0-10.8 3.5-10.8 9.8V241.5c58 .5 88.5-2.5 88.5-2.5 29.8-1 27.6-8.5 40.8-65.3h25.8c-4.4 101.4-3.9 61.8-1.8 160.3H257c-9.2-40.1-9.1-61-39.5-61.5 0 0-21.5-2-88-2v139c0 26 14.3 38.3 44.3 38.3H263c63.6 0 66.6-25 98.8-99.8H384z" />
								</svg>
							</a>
						</div>
					</div>
		...
		<div class="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
			<div
				...
				<img alt="" loading="lazy" width="3744" height="5616" decoding="async" data-nimg="1"
					class="absolute inset-0 h-full w-full object-cover" sizes="(min-width: 640px) 18rem, 11rem"
					src="https://images.unsplash.com/photo-1455390582262-044cdead277a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YXV0aG9yfGVufDB8fDB8fHww"
			...
			<div
				...
				<img alt="" loading="lazy" width="3936" height="2624" decoding="async" data-nimg="1"
					class="absolute inset-0 h-full w-full object-cover" sizes="(min-width: 640px) 18rem, 11rem"
					src="https://images.unsplash.com/photo-1594312915251-48db9280c8f1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YXV0aG9yfGVufDB8fDB8fHww"
					style="color: transparent;">
			</div>
			<div
				class="relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 rotate-2">
				<img alt="" loading="lazy" width="5760" height="3840" decoding="async" data-nimg="1"
					class="absolute inset-0 h-full w-full object-cover" sizes="(min-width: 640px) 18rem, 11rem"
					src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGF1dGhvcnxlbnwwfHwwfHx8MA%3D%3D"
					style="color: transparent;">
			</div>
			<div
				class="relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 rotate-2">
				<img alt="" loading="lazy" width="2400" height="3000" decoding="async" data-nimg="1"
					class="absolute inset-0 h-full w-full object-cover" sizes="(min-width: 640px) 18rem, 11rem"
					src="https://images.unsplash.com/photo-1505682634904-d7c8d95cdc50?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGF1dGhvcnxlbnwwfHwwfHx8MA%3D%3D"
					style="color: transparent;">
			</div>
			<div
				class="relative aspect-9/10 w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 sm:w-72 sm:rounded-2xl dark:bg-zinc-800 -rotate-2">
				<img alt="" loading="lazy" width="4240" height="2384" decoding="async" data-nimg="1"
					src="https://plus.unsplash.com/premium_photo-1673958390878-7d1bea717190?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Y3JhZnRzfGVufDB8fDB8fHww"
					style="color: transparent;">
			</div>
		</div>
	</div>
