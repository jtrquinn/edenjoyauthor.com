											...
											<div class="pointer-events-auto">
												<button id="themeSwitcher" type="button"
													...
													<svg viewBox="0 0 24 24" stroke-width="1.5" stroke-linecap="round"
														...
														class="h-6 w-6 fill-zinc-100 stroke-zinc-500 transition group-hover:fill-zinc-200 group-hover:stroke-zinc-700 dark:hidden [@media(prefers-color-scheme:dark)]:fill-teal-50 [@media(prefers-color-scheme:dark)]:stroke-ej-gold [@media(prefers-color-scheme:dark)]:group-hover:fill-teal-50 [@media(prefers-color-scheme:dark)]:group-hover:stroke-ej-purple">
														<path
