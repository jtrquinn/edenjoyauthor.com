...
define("TAILWIND_CLASSES", "absolute active:bg-zinc-800 active:text-zinc-100/70 appearance-none bg-ej-gold bg-ej-gold/25 bg-ej-green bg-ej-blue bg-white block bottom-0 dark:bg-zinc-700 dark:bg-zinc-700/[0.15] dark:bg-zinc-800/50 dark:border-zinc-700/40 dark:fill-zinc-800 dark:focus:border-ej-gold dark:focus:ring-ej-gold/10 dark:hover:bg-zinc-600 dark:placeholder:text-zinc-500 dark:text-zinc-100 dark:text-zinc-200 dark:text-zinc-400 dark:text-zinc-500 dark:active:bg-zinc-700 dark:active:text-zinc-100/70 fill-ej-dark-green flex flex-col flex-auto flex-none font-bold font-medium fond-semibold gap-10 gap-16 gap-5 gap-6 gap-y-12 gap-y-16 gap-y-20 group group-hover:opacity-100 group-hover:scale-100 h-4 h-6 h-20 h-auto h-full h-[20rem] hover:brightness-125 hover:cursor-pointer hover:bg-zinc-700 inline-flex inset-y-0 italic items-center items-start justify-center leading-none left-0 left-1/2 lg:gap-12 lg:justify-start lg:max-w-none lg:order-first lg:px-8 lg:ps-0 lg:ps-8 lg:text-start lg:grid-cols-2 lg:grid-rows-[auto_1fr] max-w-xs max-w-xl max-w-2xl max-w-5xl max-w-7xl mb-3 mb-4 mb-7 ml-1 ml-3 mt-2 mt-4 mt-6 mt-12 mx-auto my-12 opacity-0 order-first overflow-hidden p-4 p-6 pb-4 pb-12 placeholder:text-zinc-400 pl-3.5 px-2 px-2.5 px-4 px-10 py-1 py-2 py-4 py-[calc(--spacing(2)-1px)] relative rounded-full rounded-md rounded-2xl scale-95 shadow-inner shadow-md shadow-zinc-800/5 sm:-inset-x-6 sm:mt-24 sm:px-8 sm:rounded-2xl sm:text-sm space-y-3 space-y-8 stroke-current stroke-ej-green text-base text-center text-ej-gold text-ej-green text-ej-dark-green text-lg text-sm text-white text-xl text-2xl text-4xl text-7xl text-zinc-100 text-zinc-200 text-zinc-400 text-zinc-500 text-zinc-600 text-zinc-800 text-zinc-900 top-0 tracking-tight transform transition w-0.5 w-1/2 w-4 w-6 w-full w-fit w-screen z-0 z-10 z-20");
