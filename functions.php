...
function social_icon_svg_shortcode($atts)
{
	...
	if (!$atts['vertical']) {
		...
		$content = str_replace('{{cssClass}}', 'group flex text-sm font-medium text-zinc-800 transition hover:text-ej-green dark:text-zinc-200 dark:hover:text-ej-gold', $content);
