...
define("TAILWIND_CLASSES", "italic sm:pt-30 mb-7 rotate-3 overflow-hidden gap-6 max-w-xs px-2.5 lg:max-w-none lg:pl-20 lg:order-first lg:row-span-2 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12 sm:px-8 mt-24 md:mt-28 mx-auto w-full max-w-7xl lg:px-8 relative px-4 lg:px-12 max-w-2xl lg:max-w-5xl max-w-xl gap-y-20 mb-4 sm:mt-24 max-w-7xlxl:px-8 space-y-10 rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40 flex justify-center pb-4 h-[20rem] sm:h-[30rem] space-y-3 text-ej-teal text-2xl font-bold text-ej-gold text-lg fond-semibold italic text-zinc-800 dark:text-zinc-100 text-sm font-semibold text-zinc-900 h-6 w-6 flex-none ml-3 mt-2 text-zinc-600 dark:text-zinc-400 mt-6 min-w-0 flex-auto appearance-none rounded-md border-zinc-900/10 bg-white px-3 py-[calc(--spacing(2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-ej-teal focus:ring-4 focus:ring-ej-teal/10 focus:outline-hidden sm:text-sm dark:border-zinc-700 dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-ej-gold dark:focus:ring-ej-gold/10 inline-flex items-center gap-2 py-2 outline-offset-2 transition active:transition-none bg-zinc-800 text-zinc-100 hover:bg-zinc-700 active:bg-zinc-800 active:text-zinc-100/70 dark:bg-zinc-700 dark:hover:bg-zinc-600 dark:active:bg-zinc-700 dark:active:text-zinc-100/70 ml-4 hover:cursor-pointer flex-col gap-16 lg:ps-8 group items-start text-base tracking-tight absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-zinc-800/50 z-20 z-10 order-first mb-3 text-zinc-400 dark:text-zinc-500 pl-3.5 inset-y-0 left-0 h-4 w-0.5 rounded-full bg-zinc-200 dark:bg-zinc-500 mt-4 font-medium ml-1 w-4 stroke-current md:ps-12 text-4xl sm:text-5xl stroke-ej-teal fill-white dark:fill-zinc-800 xl:px-8 lg:px-24 mt-12 w-fit lg:ps-0 text-center lg:text-start gap-y-6 px-10 lg:justify-start text-xl space-y-8 pt-12 xl:grid-cols-3 xl:col-span-2 bg-ej-teal text-white hover:brightness-125 gap-10 left-1/2 transform -translate-x-1/2 w-screen h-full top-0 leading-none block fill-ej-dark-green px-24 gap-5 bottom-0 pt-4 py-1 px-2 tracking-tight text-ej-dark-green");
