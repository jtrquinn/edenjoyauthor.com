...
define("TAILWIND_CLASSES", "-translate-x-1/2 appearance-none block bottom-0 bg-ej-blue bg-ej-gold bg-ej-gold/25 bg-ej-teal bg-white bg-zinc-200 bg-zinc-50 bg-zinc-800 border border-zinc-100 border-zinc-900/10 dark:bg-zinc-700 dark:bg-zinc-700/[0.15] dark:bg-zinc-800/50 dark:border-zinc-700 dark:fill-zinc-800 dark:focus:border-ej-gold dark:focus:ring-ej-gold/10 dark:placeholder:text-zinc-500 dark:text-zinc-100 dark:text-zinc-200 dark:text-zinc-400 dark:hover:bg-zinc-600 dark:active:bg-zinc-700 dark:active:text-zinc-100/70 fill-ej-blue fill-white flex flex-auto flex-col flex-none font-bold font-medium font-semibold fond-semibold gap-10 gap-16 gap-2 gap-5 gap-6 gap-y-16 gap-y-20 gap-y-6 grid grid-cols-1 group group-hover:opacity-100 group-hover:scale-100 h-20 h-4 h-6 h-auto h-full h-[20rem] hover:bg-zinc-700 hover:brightness-125 hover:cursor-pointer inline-flex inset-y-0 items-center items-start italic justify-center lg:gap-y-12 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:justify-start lg:order-first lg:pl-20 lg:ps-0 lg:ps-8 lg:px-12 lg:px-24 lg:px-8 lg:text-start left-0 left-1/2 leading-none max-w-2xl max-w-5xl max-w-7xl max-w-7xlxl:px-8 max-w-xl mb-3 mb-4 mb-7 min-w-0 ml-1 ml-3 ml-4 mt-12 mt-2 mt-24 mt-4 mt-6 mx-auto opacity-0 order-first outline-offset-2 overflow-hidden p-4 pb-12 pb-4 pl-3.5 pt-12 pt-4 px-10 px-2 px-2.5 px-24 px-3 px-4 py-1 py-2 py-4 py-[calc(--spacing(2)-1px)] relative rounded-full rounded-2xl scale-95 shadow-inner shadow-md shadow-zinc-800/5 sm:-inset-x-6 sm:h-[30rem] sm:mt-24 sm:px-8 sm:pt-30 sm:rounded-2xl sm:text-5xl sm:text-sm space-y-10 space-y-3 space-y-8 stroke-current stroke-ej-teal text-2xl text-4xl text-7xl text-base text-center text-ej-blue text-ej-gold text-ej-teal text-lg text-sm text-white text-xl text-zinc-100 text-zinc-400 text-zinc-600 text-zinc-800 text-zinc-900 top-0 tracking-tight transform transition w-0.5 w-1/2 w-4 w-6 w-fit w-full w-screen z-0 z-10 z-20 relative mx-auto w-full max-w-7xl mt-12 max-w-2xl lg:max-w-5xl grid max-w-xl grid-cols-1 gap-y-6 lg:max-w-none lg:grid-cols-2 rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40 px-10 flex justify-center flex-col justify-center text-xl font-semibold text-zinc-900 dark:text-zinc-100 flex items-center h-6 w-6 flex-none stroke-ej-green fill-white dark:fill-zinc-800 ml-3 w-fit mt-2 px-4 lg:ps-0 text-center lg:text-start text-sm text-zinc-600 dark:text-zinc-400");
...
function social_icon_svg_shortcode($atts)
{
	...
	if (!$atts['vertical']) {
		...
		$content = str_replace('{{cssClass}}', 'group flex text-sm font-medium text-zinc-800 transition hover:text-ej-teal dark:text-zinc-200 dark:hover:text-ej-gold', $content);
